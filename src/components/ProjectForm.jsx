...
const ProjectForm = ({ project: initialProject, onSave, onCancel }) => {
  ...
  return (
    <form className="input-group vertical" onSubmit={handleSubmit}>
      <label htmlFor="wisata"> Project Name </label>
      <input
        type="text"
        name="wisata"
      ...
      />
      <label htmlFor="keterangan"> Project Description </label>
      <textarea
        name="keterangan"
        ...
        onChange={handleChange}
      ></textarea>
      <label htmlFor="alamat"> Project Alamat </label>
      <input
        type="text"
        name="alamat"
        ...
        onChange={handleChange}
      />
      <label htmlFor="harga"> Project Harga </label>
      <input
        type="number"
        name="harga"
